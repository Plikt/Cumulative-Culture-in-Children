...
values = [4, 6, 8, 12, 16, 24,36] #array of gears w desired teeth numbers
...
sort = df.sort_values(by = ['SpeedRatio'])
print(sort)

sort.to_csv("C:/Users/Psych account/Documents/gearpermutations/20210720gearpermutations.csv")                  
